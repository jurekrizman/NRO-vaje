...
int main() {
  ...
  // Sedaj imamo A in b. Lahko napišemo Gauss-Seidel metodo. Najprej
  // inicializiramo vektor rešitve T, npr. na 100 stopinj.
        for (int ii = 0; ii < 2000; ii++) {
            // ... (ostali deli kode ostanejo nespremenjeni)

            // Sedaj imamo A in b. Lahko napišemo Gauss-Seidel metodo. Najprej
            // inicializiramo vektor rešitve T, npr. na 100 stopinj.
            vector<double> T(n_b, 100);  // Uporabite eno samo inicializacijo vektorja
...
#pragma omp parallel for reduction(+:sigma)
            ...
            return 0; // Ta return statement zaključi izvajanje programa
        }
